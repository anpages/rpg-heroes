...
export const BUILDING_PRODUCTION = {
  ...
  // herb_garden: L1=5h5m,  L5=1h15m (~25% más lento que mina)
  ...
  herb_garden: { resource: 'herbs', ratePerHour: [11, 16, 22, 32, 45], cap: 56  },
...
export const RECIPE_MIN_BASE_LEVEL = {
  ...
  forge_stone_t2:     5,
  forge_stone_t3:     5,
  // T1 runes: base 5 (desbloqueadas junto con forge stones)
  rune_attack:        5,
  rune_defense:       5,
  rune_hp:            5,
  rune_strength:      5,
  rune_agility:       5,
  rune_intelligence:  5,
  // T2 runes y combinadas por clase: base 7
  rune_attack_ii:       7,
  rune_defense_ii:      7,
  rune_hp_ii:           7,
  rune_strength_ii:     7,
  rune_agility_ii:      7,
  rune_intelligence_ii: 7,
  rune_iron_will:       7,
  rune_bulwark:         7,
  rune_swift_strike:    7,
  rune_shadow_veil:     7,
