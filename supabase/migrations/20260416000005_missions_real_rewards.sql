-- Añadir columnas de recompensas adicionales a daily_missions
ALTER TABLE daily_missions
  ADD COLUMN IF NOT EXISTS reward_fragments integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS reward_essence   integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS reward_scroll    integer NOT NULL DEFAULT 0;

-- Actualizar claim_mission_atomic para incluir fragmentos y esencia
